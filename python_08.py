...
# sozluk = { {'ali' : 25, 'veli' :30, 'ayse' : 35} : 'mehmet', 7: 'ahmet', 9: 'fatma' }
# sozluk
...
sozluk.get('ali')
sozluk.get('hasan')
sozluk.get('hasan','Kardesim duzgun yaz, Öyle bir key degeri yok')
...
print(list(school_records['grades_info']['teen']['joseph']))
